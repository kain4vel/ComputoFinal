            ...
            ($scope.user_data = {
                ...
                alerts: [
                    ...
                    },
                    {
                        ...
                        content:
                            "Enim et voluptatem maiores ab fugiat commodi aut repellendus.",
                        type: "danger"
                    },
                    {
                ...
                messages: [
                    {
                        ...
                        content:
                            "In adipisci amet nostrum natus recusandae animi fugit consequatur.",
                        sender: "Korbin Doyle",
                        color: "cyan"
                    },
                    {
                        ...
                        content:
                            "Voluptate aut quis rerum laborum expedita qui eaque doloremque a corporis.",
                        sender: "Alia Walter",
                        color: "indigo",
                    ...
                    },
                    {
                        title: "At quia quis.",
                        content:
                            "Fugiat rerum aperiam et deleniti fugiat corporis incidunt aut enim et distinctio.",
                    ...
                    },
                    {
                        title: "Incidunt sunt.",
                        content:
                            "Accusamus necessitatibus officia porro nisi consectetur dolorem.",
                    ...
                    },
                    {
                        title: "Porro ut.",
                        content:
                            "Est vitae magni eum expedita odit quisquam natus vel maiores.",
                ...
                $(".header_main_search_form").on(
                    "click",
                    "#autocomplete_results .item",
                    function (e) {
                        e.preventDefault();
                        var $this = $(this);
                        $state.go($this.attr("href")), $(".header_main_search_input").val("");
                    }
                );
        }
    ])
