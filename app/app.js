...
var PREPIEGGApp = angular.module('PREPIEGGApp', [
    'ui.router',
    'oc.lazyLoad',
    'ngSanitize',
    'ngRetina',
...
PREPIEGGApp.constant('variables', {
    header_main_height: 107,
    easing_swiftOut: [ 0.4,0,0.2,1 ],
    bez_easing_swiftOut: $.bez([ 0.4,0,0.2,1 ])
});

PREPIEGGApp.config(function($sceDelegateProvider) {
...
// breadcrumbs
PREPIEGGApp.config(function($breadcrumbProvider) {
    $breadcrumbProvider.setOptions({
        prefixStateName: 'desktop.gubernatura_entidad',
